...
//
// Every delivery carries an `X-Conceps-Signature` header so receivers
// can verify the request really came from Conceps WA and wasn't tampered
// with or replayed. The scheme is Stripe-style:
//
//   X-Conceps-Signature: t=<unix_seconds>,v1=<hex HMAC-SHA256>
//
...
/**
 * Build the `X-Conceps-Signature` header value for `rawBody`, signed
...
/**
 * Verify a signature header. Exposed so a Conceps WA integration

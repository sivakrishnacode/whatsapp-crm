/**
 * Fallback-policy resolver — ported verbatim from
 * apps/web/src/lib/flows/fallback.ts.
 *
 ...
 * node. Kept free of Prisma / Meta so it stays unit-testable.
 *
 ...
 * The timeout-sweep job reuses `resolveFallbackPolicy` for its
 * per-run `on_timeout_hours` cutoff.
 */

import { DEFAULT_FALLBACK_POLICY, type FlowFallbackPolicy } from './flow.types';

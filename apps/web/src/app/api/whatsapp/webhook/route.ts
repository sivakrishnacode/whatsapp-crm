...
async function processMessage(
  ...
  // Automations now run in apps/api (NestJS) — dispatch via the internal
  // machine-to-machine bridge instead of the old in-process engine call.
  // Still fire-and-forget: no `await`, `.catch` only, so a slow/failing

# Conceps WA — WhatsApp CRM Platform

> Self-hostable WhatsApp CRM platform for agencies — shared inbox, contacts,
...
This repo is the Conceps WA product — clone or fork it to run your own WhatsApp CRM.
...
```bash
# Fork on GitHub first: https://github.com/your-org/conceps-wa → Fork
git clone https://github.com/<your-username>/conceps-wa.git
cd conceps-wa
npm install
...
<p align="center">
  <a href="https://conceps.tech/docs/deployment-hostinger">
    <img src="https://img.shields.io/badge/Step--by--step_guide-Deployment_Docs-111?style=for-the-badge" alt="Step-by-step guide" height="44">
  </a>
</p>

**Conceps WA is built to run on [Hostinger](https://www.hostinger.com/web-apps-hosting).**
...
**[conceps.tech/docs/deployment-hostinger](https://conceps.tech/docs/deployment-hostinger)**.

> _Note: Conceps WA is MIT-licensed and runs anywhere Node.js does
...
**[conceps.tech/docs](https://conceps.tech/docs)**
(source: [ArnasDon/wacrm-site](https://github.com/ArnasDon/wacrm-site)).

Key pages:
- [Getting started](https://conceps.tech/docs/getting-started)
- [Supabase setup](https://conceps.tech/docs/supabase-setup)
- [WhatsApp setup](https://conceps.tech/docs/whatsapp-setup)
- [Environment variables](https://conceps.tech/docs/environment-variables)
- [Deploy on Hostinger](https://conceps.tech/docs/deployment-hostinger)
- [Architecture](https://conceps.tech/docs/architecture)
- [Troubleshooting](https://conceps.tech/docs/troubleshooting)

...
```bash
# 1. Fork on GitHub: https://github.com/your-org/conceps-wa → Fork
# 2. Clone your fork
...
```bash
git remote add upstream https://github.com/your-org/conceps-wa.git  # once
git fetch upstream
git checkout main
...
[bug report](https://github.com/your-org/conceps-wa/issues/new?template=bug_report.yml)
...
- Rebrand. The "CRM Template for WhatsApp" name, favicon, and
  `conceps.tech` URL belong to the upstream project; please swap them
